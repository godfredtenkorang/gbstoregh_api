...
class Product(models.Model):
    ...
    image1 = models.ImageField(upload_to='product_img/one', default='default.jpg')
    image2 = models.ImageField(upload_to='product_img/two', default='default.jpg')
    image3 = models.ImageField(upload_to='product_img/three', default='default.jpg')
